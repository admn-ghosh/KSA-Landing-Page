  ...
  return (
    <section className="py-12 bg-stone-100">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-emerald-900 mb-8 text-center">Projects and Deliveries in Saudi Arabia</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-2/3">
            ...
            <p className="font-semibold text-emerald-900 text-base md:text-lg leading-relaxed">
              Many clients now rely on Ghosh Group as their preferred sandwich panel supplier in Saudi Arabia, proudly serving the Kingdom’s Vision projects from UAE.
            </p>
          </div>
